...
def update_intervention_location(intervention_Id):
    ...
    if can_not_edit:
        ...
        # UPDATE INTERVENTION SET (LATITUDE,LONGTITUDE) = ('','') WHERE INCIDENTID = INCIDENTID;
        return jsonify({
            "status": 200,
...
def update_redflag_location(redflag_Id):
    ...
    if can_not_edit:
        ...
        incident_obj.locationLong=locationLong_value
        incident_obj.locationLat=locationLat_value
        # UPDATE REDFLAG SET (LATITUDE,LONGTITUDE) = ('','') WHERE INCIDENTID = INCIDENTID;
        return jsonify({
            "status": 200,
            "data": {"id":incident_obj.incidentId,
...
def update_intervention_comment(intervention_Id):
    ...
    if can_not_edit:
        ...
        # UPDATE INTERVENTION SET COMMENT = '' WHERE INCIDENTID = INCIDENTID;
        return jsonify({
            "status": 200,
            "data": {"id":incident_obj.incidentId,
...
def update_redflag_comment(redflag_Id):
    ...
    if can_not_edit:
        ...
        comment_value = data['comment']
        incident_obj.comment = comment_value
        # UPDATE REDFLAG SET COMMENT = '' WHERE INCIDENTID = INCIDENTID;     
        return jsonify({
            "status": 200,
            "data": [{
...
def delete_intervention(intervention_Id):
    ...
    if intervention:
        ...
        del intervention
        # DELETE FROM INTERVENTION WHERE INCIDENTID = INCIDENTID;
...
def delete_redflag(redflag_Id):
    ...
    if red_flag:
        ...
        del red_flag
        # DELETE FROM REDFLAG WHERE INCIDENTID = INCIDENTID;
        return jsonify({"status": 200,
            "data": {"id": redflag_Id,
...
def update_intervention_status(intervention_Id):
    ...
    if intervention:
        ...
        # UPDATE INTERVENTION SET STATUS = '' WHERE INCIDENTID = INCIDENTID;
        return jsonify({
            "status": 200,
            "data": [{
...
def update_redflag_status(redflag_Id):
    ...
    if red_flag:
        ...
        # UPDATE REDFLAG SET STATUS = '' WHERE INCIDENTID = INCIDENTID;
        return jsonify({
            "status": 200,
...
def create_intervention():
    ...
    if data:
        ...
        # INSERT INTO INTERVENTION (INCIDENTID,CREATEDBY,INCIDENTTYPE,COMMENT,STATUS,
        # IMAGES,VIDEOS,CREATEDON,LATITUDE,LONGTITUDE)
         # VALUES (2,2,'interventon','Mbarara highway needs construction','draft',
            # '1.jpeg','1.gif', DEFAULT,5.38974,0.33737);
        return jsonify({
            "status": 201,
            "data": [{
...
def create_redflag():
    ...
    if data:
        ...
        # INSERT INTO REDFLAG (INCIDENTID,CREATEDBY,INCIDENTTYPE,COMMENT,STATUS,
        # IMAGES,VIDEOS,CREATEDON,LATITUDE,LONGTITUDE)
